...
class TestNonHeightCommands:
    @pytest.mark.parametrize("command", ["forward", "back", "left", "right", "turn_left", "turn_right"])
...
class TestUpCommand:
    ...
    @pytest.mark.parametrize("initial_h,distance,expected_clamped,expected_height", [
